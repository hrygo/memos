...
- [web/src/locales/ar.json](file://web/src/locales/ar.json)
- [web/src/locales/fa.json](file://web/src/locales/fa.json)
...
- 语言包：web/src/locales/*.json（含 en、zh-Hans、ar、fa 等）
...
图表来源
- [web/src/i18n.ts](file://web/src/i18n.ts#L1-L41)
...
- [web/src/locales/en.json](file://web/src/locales/en.json#L1-L1047)
- [web/src/locales/zh-Hans.json](file://web/src/locales/zh-Hans.json#L1-L1042)
- [web/src/locales/ar.json](file://web/src/locales/ar.json#L1-L423)
- [web/src/locales/fa.json](file://web/src/locales/fa.json#L1-L398)
...
- 语言包：locales 目录包含多种语言 JSON 文件，覆盖界面文案、消息、设置项等。
...
- 语言包结构：按功能域分层（common、auth、setting、memo 等），便于维护与扩展。
...
- 翻译工作流：
  ...
  - 同步校验：运行 scripts/check-i18n.sh 对比 en.json 与目标语言包的 key 完整性。
...
## 结论
本项目采用 i18next + 自定义懒加载后端的架构，结合用户偏好与浏览器语言检测，实现了稳定高效的多语言支持。通过类型化翻译、RTL 自动适配、完善的质量保障脚本与清晰的开发示例，能够有效支撑多语言产品的持续演进与高质量交付。

## 附录
- 语言包示例路径：
  - 英文：[web/src/locales/en.json](file://web/src/locales/en.json#L1-L1047)
  - 简体中文：[web/src/locales/zh-Hans.json](file://web/src/locales/zh-Hans.json#L1-L1042)
  - 阿拉伯语：[web/src/locales/ar.json](file://web/src/locales/ar.json#L1-L423)
  - 波斯语：[web/src/locales/fa.json](file://web/src/locales/fa.json#L1-L398)
- 质量保障脚本：
