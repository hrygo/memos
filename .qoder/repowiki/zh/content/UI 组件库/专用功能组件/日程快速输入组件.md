...
2. **AISuggestionCards** - AI 建议卡片展示，支持双击创建和键盘导航
3. **QuickTemplates** - 快捷模板系统，提供预设的日程模板
4. **StreamingScheduleAssistant** - 流式 AI 助手，支持工具调用和实时响应
5. **ScheduleAISidebar** - AI 侧边栏，提供快捷操作和建议
...
日程快速输入组件采用前后端分离的架构设计，结合了现代前端框架的最佳实践和后端微服务架构的优势。
