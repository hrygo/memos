 ...
 *
 * @generated from message memos.api.v1.SearchWithHighlightRequest
 */
export type SearchWithHighlightRequest = Message<"memos.api.v1.SearchWithHighlightRequest"> & {
  /**
   ...
   *
   * @generated from field: int32 context_chars = 3;
   */
  contextChars: number;
};

/**
 * Describes the message memos.api.v1.SearchWithHighlightRequest.
 * Use `create(SearchWithHighlightRequestSchema)` to create a new message.
 */
export const SearchWithHighlightRequestSchema: GenMessage<SearchWithHighlightRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 23);

/**
 * SearchWithHighlightResponse is the response for SearchWithHighlight.
 *
 * @generated from message memos.api.v1.SearchWithHighlightResponse
 */
export type SearchWithHighlightResponse = Message<"memos.api.v1.SearchWithHighlightResponse"> & {
  /**
   * The list of highlighted memos.
   *
   * @generated from field: repeated memos.api.v1.HighlightedMemo memos = 1;
   */
  memos: HighlightedMemo[];
};

/**
 * Describes the message memos.api.v1.SearchWithHighlightResponse.
 * Use `create(SearchWithHighlightResponseSchema)` to create a new message.
 */
export const SearchWithHighlightResponseSchema: GenMessage<SearchWithHighlightResponse> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 24);

/**
 * HighlightedMemo represents a memo with highlighted search matches.
 *
 * @generated from message memos.api.v1.HighlightedMemo
 */
export type HighlightedMemo = Message<"memos.api.v1.HighlightedMemo"> & {
  /**
   ...
   *
   * @generated from field: repeated memos.api.v1.Highlight highlights = 4;
   */
...
/**
 * Describes the message memos.api.v1.HighlightedMemo.
 * Use `create(HighlightedMemoSchema)` to create a new message.
 */
export const HighlightedMemoSchema: GenMessage<HighlightedMemo> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 25);

/**
 * Highlight represents a highlighted match position.
 *
 * @generated from message memos.api.v1.Highlight
 */
export type Highlight = Message<"memos.api.v1.Highlight"> & {
  /**
   ...
   * The matched text.
   *
   * @generated from field: string matched_text = 3;
   */
  matchedText: string;
};

/**
 * Describes the message memos.api.v1.Highlight.
...
export const MemoService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.SearchWithHighlight
   */
  searchWithHighlight: {
    methodKind: "unary";
    input: typeof SearchWithHighlightRequestSchema;
    output: typeof SearchWithHighlightResponseSchema;
  },
}> = /*@__PURE__*/
