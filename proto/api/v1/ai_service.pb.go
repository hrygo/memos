...
const file_api_v1_ai_service_proto_rawDesc = "" +
	...
	"\n" +
	"ChatStream\x12&.memos.api.v1.ScheduleAgentChatRequest\x1a).memos.api.v1.ScheduleAgentStreamResponse\"-\x82\xd3\xe4\x93\x02':\x01*\"\"/api/v1/schedule-agent/chat/stream0\x01B\fZ\n" +
