...
const file_api_v1_schedule_service_proto_rawDesc = "" +
	...
	"\x14BatchCreateSchedules\x12).memos.api.v1.BatchCreateSchedulesRequest\x1a*.memos.api.v1.BatchCreateSchedulesResponse\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/api/v1/schedules:batchCreateB\fZ\n" +
