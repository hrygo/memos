...
const (
	...
	// Review states for spaced repetition (P3-C002).
	UserSetting_REVIEW_STATES UserSetting_Key = 8
)
...
func (x *UserSetting) GetReviewStates() *ReviewStatesUserSetting {
	if x != nil {
		if x, ok := x.Value.(*UserSetting_ReviewStates); ok {
...
type UserSetting_ReviewStates struct {
	ReviewStates *ReviewStatesUserSetting `protobuf:"bytes,10,opt,name=review_states,json=reviewStates,proto3,oneof"`
}
...
func (*UserSetting_ReviewStates) isUserSetting_Value() {}
...
// ReviewStatesUserSetting stores spaced repetition states for memos.
type ReviewStatesUserSetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Map of memo_uid to review state
	States        []*ReviewStatesUserSetting_ReviewState `protobuf:"bytes,1,rep,name=states,proto3" json:"states,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ReviewStatesUserSetting) Reset() {
	*x = ReviewStatesUserSetting{}
	mi := &file_store_user_setting_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReviewStatesUserSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReviewStatesUserSetting) ProtoMessage() {}

func (x *ReviewStatesUserSetting) ProtoReflect() protoreflect.Message {
	mi := &file_store_user_setting_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReviewStatesUserSetting.ProtoReflect.Descriptor instead.
func (*ReviewStatesUserSetting) Descriptor() ([]byte, []int) {
	return file_store_user_setting_proto_rawDescGZIP(), []int{6}
}

func (x *ReviewStatesUserSetting) GetStates() []*ReviewStatesUserSetting_ReviewState {
	if x != nil {
		return x.States
	}
	return nil
...
type ReviewStatesUserSetting_ReviewState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Memo UID
	...
	LastReviewTs int64 `protobuf:"varint,3,opt,name=last_review_ts,json=lastReviewTs,proto3" json:"last_review_ts,omitempty"`
	// Next scheduled review timestamp (Unix seconds)
	NextReviewTs int64 `protobuf:"varint,4,opt,name=next_review_ts,json=nextReviewTs,proto3" json:"next_review_ts,omitempty"`
	// SM-2 ease factor (default: 2.5)
	EaseFactor float64 `protobuf:"fixed64,5,opt,name=ease_factor,json=easeFactor,proto3" json:"ease_factor,omitempty"`
...
func (x *ReviewStatesUserSetting_ReviewState) Reset() {
	*x = ReviewStatesUserSetting_ReviewState{}
	mi := &file_store_user_setting_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReviewStatesUserSetting_ReviewState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReviewStatesUserSetting_ReviewState) ProtoMessage() {}

func (x *ReviewStatesUserSetting_ReviewState) ProtoReflect() protoreflect.Message {
	mi := &file_store_user_setting_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReviewStatesUserSetting_ReviewState.ProtoReflect.Descriptor instead.
func (*ReviewStatesUserSetting_ReviewState) Descriptor() ([]byte, []int) {
	return file_store_user_setting_proto_rawDescGZIP(), []int{6, 0}
}

func (x *ReviewStatesUserSetting_ReviewState) GetMemoUid() string {
	if x != nil {
		return x.MemoUid
	}
	return ""
...
func (x *ReviewStatesUserSetting_ReviewState) GetReviewCount() int32 {
	if x != nil {
...
func (x *ReviewStatesUserSetting_ReviewState) GetLastReviewTs() int64 {
	if x != nil {
...
func (x *ReviewStatesUserSetting_ReviewState) GetNextReviewTs() int64 {
	if x != nil {
...
func (x *ReviewStatesUserSetting_ReviewState) GetEaseFactor() float64 {
	if x != nil {
		return x.EaseFactor
	}
	return 0
...
func (x *ReviewStatesUserSetting_ReviewState) GetIntervalDays() int32 {
	if x != nil {
...
const file_store_user_setting_proto_rawDesc = "" +
	"\n" +
	"\x18store/user_setting.proto\x12\vmemos.store\x1a\x1fgoogle/protobuf/timestamp.proto\"\xac\x05\n" +
	...
	"\x16personal_access_tokens\x18\t \x01(\v2,.memos.store.PersonalAccessTokensUserSettingH\x00R\x14personalAccessTokens\x12K\n" +
	"\rreview_states\x18\n" +
	" \x01(\v2$.memos.store.ReviewStatesUserSettingH\x00R\freviewStates\"\x87\x01\n" +
	"\x03Key\x12\x13\n" +
	...
	"\x16PERSONAL_ACCESS_TOKENS\x10\a\x12\x11\n" +
	"\rREVIEW_STATES\x10\bB\a\n" +
	"\x05value\"k\n" +
	...
	"\x03url\x18\x03 \x01(\tR\x03url\"\xc3\x02\n" +
	"\x17ReviewStatesUserSetting\x12H\n" +
	"\x06states\x18\x01 \x03(\v20.memos.store.ReviewStatesUserSetting.ReviewStateR\x06states\x1a\xdd\x01\n" +
	"\vReviewState\x12\x19\n" +
	"\bmemo_uid\x18\x01 \x01(\tR\amemoUid\x12!\n" +
	"\freview_count\x18\x02 \x01(\x05R\vreviewCount\x12$\n" +
	"\x0elast_review_ts\x18\x03 \x01(\x03R\flastReviewTs\x12$\n" +
	"\x0enext_review_ts\x18\x04 \x01(\x03R\fnextReviewTs\x12\x1f\n" +
	"\vease_factor\x18\x05 \x01(\x01R\n" +
	"easeFactor\x12#\n" +
	"\rinterval_days\x18\x06 \x01(\x05R\fintervalDaysB\vZ\tgen/storeb\x06proto3"
...
var file_store_user_setting_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_store_user_setting_proto_goTypes = []any{
	...
	(*ReviewStatesUserSetting)(nil),                             // 7: memos.store.ReviewStatesUserSetting
	...
	(*ReviewStatesUserSetting_ReviewState)(nil),                 // 13: memos.store.ReviewStatesUserSetting.ReviewState
...
var file_store_user_setting_proto_depIdxs = []int32{
	...
	7,  // 6: memos.store.UserSetting.review_states:type_name -> memos.store.ReviewStatesUserSetting
	...
	13, // 11: memos.store.ReviewStatesUserSetting.states:type_name -> memos.store.ReviewStatesUserSetting.ReviewState
	14, // 12: memos.store.RefreshTokensUserSetting.RefreshToken.expires_at:type_name -> google.protobuf.Timestamp
	14, // 13: memos.store.RefreshTokensUserSetting.RefreshToken.created_at:type_name -> google.protobuf.Timestamp
	9,  // 14: memos.store.RefreshTokensUserSetting.RefreshToken.client_info:type_name -> memos.store.RefreshTokensUserSetting.ClientInfo
	14, // 15: memos.store.PersonalAccessTokensUserSetting.PersonalAccessToken.expires_at:type_name -> google.protobuf.Timestamp
	14, // 16: memos.store.PersonalAccessTokensUserSetting.PersonalAccessToken.created_at:type_name -> google.protobuf.Timestamp
	14, // 17: memos.store.PersonalAccessTokensUserSetting.PersonalAccessToken.last_used_at:type_name -> google.protobuf.Timestamp
